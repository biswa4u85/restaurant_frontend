            ...
            <div className="container">
                <div className="row mt-5 check-buttons">
                    <button onClick={() => setDeliveryType("Dine-In")} className={"btn form-control text-start py-3 takeout-btn " + (deliveryType == "Dine-In" ? "btn-danger" : "")} id="1">
                        <img src="https://restaurant.scrollmonkey.com/files/Vector5.png" alt="" className="me-2" /> Dine-In
                        <img src="https://restaurant.scrollmonkey.com/files/Vector (2).png" className="float-end me-2 mt-1 success1 s-icon d-none" />
                    </button>
                    <button onClick={() => setDeliveryType("Take Away")} className={"btn form-control text-start mt-3 py-3 takeout-btn " + (deliveryType == "Take Away" ? "btn-danger" : "")} id="2">
                        <img src="https://restaurant.scrollmonkey.com/files/Vector6.png" alt="" className="me-2" /> Take Away
                        <img src="https://restaurant.scrollmonkey.com/files/Vector (2).png" className="float-end me-2 mt-1 success2 s-icon d-none" />
                    </button>
